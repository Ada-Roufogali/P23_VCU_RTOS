...
extern uint8_t initial_check_previous,initial_check_current,vcu_hb, apps_deviation,apps_plausibility,brake_deviation,brake_plausibility,power_limit_active,S_BSPD;
