...
TimerHandle_t Primary1CanTimer;
TimerHandle_t Primary2CanTimer;
...
uint32_t apps_time,apps_no_implausibility,sd_opened_val;
uint8_t S_BSPD,disable_S_BSPD;
